...
## What's it about?
This program simulates a forest fire on a *GPU (or some other device)*. (NOTE: THIS PROJECT WAS TESTED ON INTEGRATED GPUS ONLY. IT MAY NOT WORK ON OTHER DEVICES AS SUCH.)
